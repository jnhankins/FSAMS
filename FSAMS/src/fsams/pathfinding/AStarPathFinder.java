...
public class AStarPathFinder implements PathFinder {
     ...
     * @param allowDiagMovement True if the search should try diaganol movement
     */
    public AStarPathFinder(Grid map, int maxSearchDistance, boolean allowDiagMovement, AStarHeuristic heuristic) {
    ...
    public int getDirection(int sx, int sy, int tx, int ty) {
        if (sy < ty)
            return 0;
        else if (sy > ty)
            return 1;
